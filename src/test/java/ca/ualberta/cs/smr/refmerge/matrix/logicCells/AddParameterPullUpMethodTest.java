...
public class AddParameterPullUpMethodTest extends LightJavaCodeInsightFixtureTestCase {

    /*
     * Add parameter before pull up method
     */
    public void testCheckCombination() {
        ...
        AddParameterPullUpMethodCell.checkCombination(pullUpMethodObject, addParameterObject);
        Assert.assertTrue(pullUpMethodObject.getOriginalMethodSignature().equalsSignature(addParameterObject.getOriginalMethod()));
    }
    ...
    public void testCheckCombination2() {
        ...
        AddParameterPullUpMethodCell.checkCombination(pullUpMethodObject, addParameterObject);
        Assert.assertTrue(pullUpMethodObject.getDestinationMethodSignature().equalsSignature(addParameterObject.getDestinationMethod()));
    }
}
