...
public class UndoOperationsTests extends LightJavaCodeInsightFixtureTestCase {
    ...
    public void testInvertRenameParameter() {
        ...
        List<Refactoring> refactorings = GetDataForTests.getRefactorings("RENAME_PARAMETER", refactoredPath, originalPath);
        assert refactorings != null;
        Refactoring ref = refactorings.get(0);
        RefactoringObject object = new RenameParameterObject(ref);
        InvertRenameParameter invert = new InvertRenameParameter(project);
        invert.invertRenameParameter(object);
