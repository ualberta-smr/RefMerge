...
public class ChangeParameterTypeExtractMethodTest extends LightJavaCodeInsightFixtureTestCase {
    ...
    public void testCheckCombination() {
        ...
        ChangeParameterTypeExtractMethodCell.checkCombination(extractMethodObject, changeParameterTypeObject);
        Assert.assertTrue(extractMethodObject.getOriginalMethodSignature().equalsSignature(changeParameterTypeObject.getDestinationMethod()));
    }

    /*
     * Change parameter type performed on extracted method
     */
    public void testCheckCombination2() {
        ...
        ChangeParameterTypeExtractMethodCell.checkCombination(extractMethodObject, changeParameterTypeObject);
        Assert.assertTrue(extractMethodObject.getDestinationMethodSignature().equalsSignature(changeParameterTypeObject.getDestinationMethod()));
    }
}
