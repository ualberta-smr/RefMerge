...
public class RemoveParameterInlineMethodTest extends LightJavaCodeInsightFixtureTestCase {
    ...
    public void testCheckCombination() {
        ...
        RemoveParameterInlineMethodCell.checkCombination(inlineMethodObject, removeParameterObject);
        Assert.assertTrue(inlineMethodObject.getOriginalMethodSignature().equalsSignature(removeParameterObject.getOriginalMethod()));
    }

    /*
     * Remove parameter from target method
     */
    public void testCheckCombination2() {
        ...
        InlineMethodObject extractMethodObject =
                new InlineMethodObject("A.java", originalClass, foo1, "A.java", originalClass, bar2);
        RemoveParameterInlineMethodCell.checkCombination(extractMethodObject, removeParameterObject);
