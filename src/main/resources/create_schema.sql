...
-- Wed 07 Jul 2021 08:01:14 PM PDT
...
CREATE TABLE IF NOT EXISTS `refMerge_evaluation`.`conflict_block` (
  ...
  `left` VARCHAR(2000) NOT NULL,
  `right` VARCHAR(2000) NOT NULL,
  `start_line` INT NOT NULL,
  `end_line` INT NOT NULL,
  `conflicting_file_id` INT NOT NULL,
  `merged_result_id` INT NOT NULL,
  `merge_commit_id` INT NOT NULL,
  `project_id` INT NOT NULL,
  PRIMARY KEY (`id`, `merged_result_id`, `merge_commit_id`, `project_id`, `conflicting_file_id`),
  INDEX `fk_conflict_block_conflicting_file1_idx` (`conflicting_file_id` ASC, `merged_result_id` ASC, `merge_commit_id` ASC, `project_id` ASC),
  CONSTRAINT `fk_conflict_block_conflicting_file1`
    FOREIGN KEY (`conflicting_file_id` , `merged_result_id` , `merge_commit_id` , `project_id`)
