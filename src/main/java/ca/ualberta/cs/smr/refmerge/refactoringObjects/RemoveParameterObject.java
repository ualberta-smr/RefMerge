...
public class RemoveParameterObject implements RefactoringObject {
    ...
    public RemoveParameterObject(String originalClass, String destinationClass, MethodSignatureObject originalMethod,
                              MethodSignatureObject destinationMethod, ParameterObject parameterObject) {
        this.refactoringDetail = "";
        this.refactoringType = RefactoringType.REMOVE_PARAMETER;
    ...
    public RemoveParameterObject(Refactoring refactoring) {
    ...
    public ParameterObject getRemovedParameterObject() {
